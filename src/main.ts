...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        const activeTierBtn = document.querySelector('.tier-btn.active') as HTMLElement;
        const difficultyTier = activeTierBtn ? activeTierBtn.textContent?.trim() : 'Standard';
    ...
    const setLoading = (loading: boolean) => {
        if (loading) {
            ...
            statusDesc.textContent = "Our AI is crafting custom questions based on your input.";
        } else {
