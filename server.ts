...
const QuestionRequestSchema = z.object({
  ...
  difficultyTier: z.enum(["Standard", "Advanced"]).optional().default("Standard"),
});
          ...
          content: {
            "application/json": {
              schema: {
                type: "object",
                properties: {
                  jobTitle: { type: "string", example: "Customer Success Manager" },
                  difficultyTier: { type: "string", enum: ["Standard", "Advanced"] },
                },
              },
            },
          },
...
app.post("/api/generate-questions", async (req, res) => {
  ...
  const modifier = difficultyTier === "Advanced"
